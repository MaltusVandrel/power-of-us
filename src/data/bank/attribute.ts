...
export const ATTRIBUTE_TITLES = {
    ...
    INTELLIGENCE:'intelligence', // how sharp and knolegeable someone is, good for most spells and mana, raises XP potential
    REASONING:'reasoning',
...
export const ATTRIBUTE_DESCRIPTIONS = {
    STRENGTH:'Represents how phisically powerful the body is, its good for phisical damage',
    ENDURANCE:'Represents the capability of sustain and mitigate damage, good for its good for defense and stamina', 
    VIGOR:'Represents the how lively the body is, its good for vitality and stamina and vigor, mildy affects positively mana', 
    AGILITY:'Represents how fast someone acts and reacts, good for attack priority, evasion, finese damage, map movement and stamina', 
    DEXTERITY:'Represents how precise someone are, good for accurracy, finese damage, stamina, and a bit of everything', 
    PERCEPTION:'Represents how sharp your senses are, good accurracy and evasion',
    INTELLIGENCE:'Represents how dependable someone mind is, good for spells, mana, and reises XP potential', 
    REASONING:'Represents how sharp someone is, good for spells, mana, raises the quickness to learn something and helps with gathering info.',
    RESOLVE:'Represents mental resilience, great for mana, good for resisting some some spells and mildly affects positively stamina', 
    CHARISMA:'Represents aprocheability and vibes, helps with interactions, good for some spells',
    INTUITION:'Represents the instrinsical instinct, the gut feeling, good for sensing deception, and gathering unspoke info', 
    ...
    ESOTERISM:'Represents familiarity with magic vibes, good for magic items, entity and god granted spells, good for mana', 
    KARMA:'Represents the intensity of your impression on entities and gods, good for interaction with otherwordly, good for granted spells and mana',
}
